...
## pixelize.py v2 プリセット一覧（2026-04-14改訂: シーン別プリセット化）

### 共通プリセット
| プリセット | サイズ | 色数 | アウトライン | chromakey | crop |
|-----------|-------|------|------------|-----------|------|
| witch | 64×64 | 32 | ○ (0.7) | ○ (40) | - |
| bg-far | 512×96 | 14 | × | - | - |
| bg-mid | 400×96 | 14 | ○ (0.3) | - | - |
| bg-mid-complex | 400×96 | 18 | ○ (0.15) | - | - |
| road | 400×16 | 8 | × | - | - |
| icon | 48×16 | 10 | ○ (0.6) | - | - |

### near層（シーン別に最適化）
raw画像の上半分が空で、下半分に前景オブジェクトがある。
`crop_top_frac` で空部分を切り捨てて、480×32に情報を凝縮する。

| プリセット | 色数 | crop_top | chromakey | 用途 |
|-----------|------|----------|-----------|------|
| bg-near-forest | 14 | 0.50 | ○ (55) | 森の草花（中央に茂み） |
| bg-near-valley | 14 | 0.60 | - | 谷の砂漠草と砂利 |
| bg-near-mountain | 14 | 0.50 | - | 山の氷と雪 |
| bg-near-castle | 14 | 0.50 | - | 城の石壁と蔦 |
| bg-near-tower | 14 | 0.55 | ○ (55) | 塔のアーチ（黒背景透過）|

### mid層のシーン別割り当て
| シーン | プリセット | 理由 |
|-------|-----------|------|
| forest | bg-mid-complex | 木々の重なりが複雑 |
| mountain | bg-mid-complex | 雪・岩・枝の情報量多 |
| valley, castle, tower | bg-mid | 比較的シンプル |
