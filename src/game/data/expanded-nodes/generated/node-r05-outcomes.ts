// Auto-generated from node-r05-outcomes.md
import type { Outcome } from '../../../engine/types';

export const nodeR05Outcomes: Outcome[] = [
  {
    id: 'r05_small_kitten',
    conditions: { s1: 'mod_small', s2: 'subj_kitten' },
    resultText: '小さな子猫が星空に輝いている。親指ほどの子猫が丘の上で星明かりに照らされている。目が星のように光る。',
    damage: 0,
    quill: 5
  },
  {
    ...
    resultText: '優しい子猫が星空に輝いている。人懐っこい猫の毛並みが星明かりで銀色に光っている。膝に乗ってきた。温かい。',
    damage: -1,
    quill: 5
  },
  {
  ...
  },
  {
    ...
    resultText: '堅い子猫が星空に輝いている。陶器の招き猫が月光で白く光っている。目だけがこちらを追っている。',
    damage: 0,
    quill: 4
  },
  {
    ...
    resultText: '鋭い子猫が星空に輝いている。硝子の爪が星明かりを反射して光っている。美しいが近づけない。',
    damage: 1,
    quill: 4
  },
  {
    ...
    resultText: '壊れた子猫が星空に輝いている。ぬいぐるみだ。綿が星明かりで白く光っている。誰かが丘に忘れたらしい。',
    damage: 0,
    quill: 4,
    rewardItems: [{ id: 'item_r05_broken_kitten', name: '星屑の綿', description: '星明かりを吸った綿。暗闇でほんのり光る', sellPrice: 5 }]
  },
  {
    id: 'r05_mighty_kitten',
    conditions: { s1: 'mod_mighty', s2: 'subj_kitten' },
    resultText: '屈強な子猫が星空に輝いている。虎の体格の子猫が丘の頂上に立っている。月を背に受けて影が大きい。',
    damage: 1,
    quill: 4
  },
  {
    ...
    resultText: '凍てついた子猫が星空に輝いている。氷の猫が星明かりで青白く光っている。寒いが美しい。',
    damage: 1,
    quill: 5
  },
  {
    ...
    resultText: '透き通った子猫が星空に輝いている。硝子の猫の中に星が映っている。猫ごと星座になったようだ。',
    damage: 0,
    quill: 7,
    rewardItems: [{ id: 'item_r05_clear_kitten', name: '猫の星座', description: '硝子猫に閉じ込められた星の光。回すと星が動く', sellPrice: 15 }]
  },
  {
    id: 'r05_cursed_kitten',
    conditions: { s1: 'mod_cursed', s2: 'subj_kitten' },
    resultText: '呪われた子猫が星空に輝いている。拾い上げたら降ろせない。星空を見上げながら猫を抱いていた。悪くはない。',
    damage: 0,
    quill: 4
  },
  {
    ...
    resultText: '眠い子猫が星空に輝いている。丘の草の上で丸くなっている。星明かりに照らされた寝顔が穏やかだ。',
    damage: 0,
    quill: 4
  },
  {
    ...
    resultText: '小さな蛇が星空に輝いている。指ほどの蛇が星明かりの下で鱗を光らせている。天の川のようだ。',
    damage: 0,
    quill: 5
  },
  {
    ...
    resultText: '優しい蛇が星空に輝いている。腕に巻きついてきた。蛇の体温と星空の冷気。ちょうどいい温かさだ。',
    damage: -1,
    quill: 5
  },
  {
  ...
  },
  {
    ...
    resultText: '堅い蛇が星空に輝いている。鉄の鱗が月光で銀に光っている。鎖が蛇の形をしたように見える。',
    damage: 1,
    quill: 4
  },
  {
  ...
  },
  {
    ...
    resultText: '壊れた蛇が星空に輝いている。脱皮の途中で力尽きた蛇。古い皮が月光で銀色に光っている。',
    damage: 0,
    quill: 4
  },
  {
  ...
  },
  {
    ...
    resultText: '凍てついた蛇が星空に輝いている。霜に覆われた蛇が月光で白銀に輝いている。冬の星座のようだ。',
    damage: 1,
    quill: 5
  },
  {
    ...
    resultText: '透き通った蛇が星空に輝いている。透明な蛇の中に星が映っている。体内に天の川が流れているように見える。',
    damage: 0,
    quill: 7,
    rewardItems: [{ id: 'item_r05_clear_snake', name: '蛇腹の星図', description: '透き通った蛇の脱皮殻。星の配置が透けて見える', sellPrice: 15 }]
  },
  {
    id: 'r05_cursed_snake',
  ...
  },
  {
    ...
    resultText: '眠い蛇が星空に輝いている。とぐろを巻いて星を見上げながら眠っている。踏まなければ安全だ。',
    damage: 0,
    quill: 3
  },
  {
    ...
    resultText: '小さな竜が星空に輝いている。手のひらサイズの竜が翼を広げて星に向かって飛んでいる。雀ほどの翼で星を追う。',
    damage: 0,
    quill: 6,
    rewardItems: [{ id: 'item_r05_small_dragon', name: '星追いの竜鱗', description: '星を追った小竜が落とした鱗。暗闇で光る', sellPrice: 10 }]
  },
  {
    id: 'r05_gentle_dragon',
    conditions: { s1: 'mod_gentle', s2: 'subj_dragon' },
    resultText: '優しい竜が星空に輝いている。穏やかな老竜が翼を広げて星空に浮かんでいる。翼の下に入ると温かい。',
    damage: -1,
    quill: 6
  },
  {
  ...
  },
  {
    ...
    resultText: '堅い竜が星空に輝いている。城壁のような鱗が月光を反射している。丘に山がもう一つあるようだ。',
    damage: 1,
    quill: 4
  },
  {
  ...
  },
  {
    ...
    resultText: '壊れた竜が星空に輝いている。折れた翼を広げて星空を仰いでいる。もう飛べない竜が、空を見上げている。',
    damage: 0,
    quill: 6,
    rewardItems: [{ id: 'item_r05_broken_dragon', name: '星を見た竜の涙', description: '壊れた竜が流した涙。月光で銀色に光る', sellPrice: 12 }]
  },
  {
  ...
  },
  {
    ...
    resultText: '透き通った竜が星空に輝いている。水晶の竜の中に星空が映っている。竜を通して見る星は歪んで、新しい星座に見える。',
    damage: 0,
    quill: 8,
    rewardItems: [{ id: 'item_r05_clear_dragon', name: '水晶竜の星座', description: '竜の体を通して見た新しい星座の記録。紙に写した', sellPrice: 20 }]
  },
  {
  ...
  },
  {
    ...
    resultText: '眠い竜が星空に輝いている。丘の上でいびきをかいて眠っている。地鳴りのようだが、起こさなければ安全だ。星は綺麗だ。',
    damage: 0,
    quill: 4
  },
  {
    ...
    resultText: '小さな蝶が星空に輝いている。星の光を鱗粉に受けて、蝶自体が星のようだ。',
    damage: 0,
    quill: 5
  },
  {
    ...
    resultText: '優しい蝶が星空に輝いている。指に止まった蝶の羽が星明かりで模様を変える。笑顔の模様が見えた。',
    damage: 0,
    quill: 5
  },
  {
  ...
  },
  {
    ...
    resultText: '堅い蝶が星空に輝いている。金属の羽が月光で銀色に光っている。飛ぶたびに金属音が星空に響く。',
    damage: 0,
    quill: 4
  },
  {
    ...
    resultText: '鋭い蝶が星空に輝いている。刃の羽が星明かりで鋭く光る。美しいが、近くを飛ぶと頬が切れそうだ。',
    damage: 1,
    quill: 4
  },
  {
    ...
    resultText: '壊れた蝶が星空に輝いている。片羽の蝶が螺旋を描いて星空に向かっている。最後の飛行のようだ。',
    damage: 0,
    quill: 6,
    rewardItems: [{ id: 'item_r05_broken_butterfly', name: '星降る鱗粉', description: '壊れた蝶が星空に散らした鱗粉。瓶に入れると光る', sellPrice: 10 }]
  },
  {
    id: 'r05_mighty_butterfly',
    conditions: { s1: 'mod_mighty', s2: 'subj_butterfly' },
    resultText: '屈強な蝶が星空に輝いている。力強い羽ばたきで星空の風が変わった。丘の上に強い風が吹く。',
    damage: 1,
    quill: 4
  },
  {
    ...
    resultText: '凍てついた蝶が星空に輝いている。霜の結晶の羽が星光でプリズムのように輝く。冬の星空にふさわしい。',
    damage: 0,
    quill: 5
  },
  {
    ...
    resultText: '透き通った蝶が星空に輝いている。透明な羽に星が映り込んで、蝶が星空を纏っている。どこまでが蝶でどこからが空か。',
    damage: 0,
    quill: 7,
    rewardItems: [{ id: 'item_r05_clear_butterfly', name: '星纏いの羽片', description: '透き通った蝶の羽の欠片。中に星空が映り続ける', sellPrice: 15 }]
  },
  {
  ...
  },
  {
    ...
    resultText: '眠い蝶が星空に輝いている。草の上で羽を閉じて眠っている。星明かりが蝶の夜灯になっている。',
    damage: 0,
    quill: 4
  },
  {
    ...
    resultText: '小さな風が星空に輝いている。そよ風が星の光を運んでくる。草がきらきらと揺れた。',
    damage: 0,
    quill: 4
  },
  {
    ...
    resultText: '優しい風が星空に輝いている。温かい追い風が星空の下を吹いている。花の匂いがする。旅の疲れが遠のく。',
    damage: -1,
    quill: 5
  },
  {
  ...
  },
  {
    ...
    resultText: '堅い風が星空に輝いている。一方向に吹き続ける風。雲が一切なく、星がくっきり見える。',
    damage: 0,
    quill: 4
  },
  {
    ...
    resultText: '鋭い風が星空に輝いている。真空の刃のような風。丘の上は寒くて肌が痛い。星はよく見える。',
    damage: 2,
    quill: 3
  },
  {
    ...
    resultText: '壊れた風が星空に輝いている。乱気流が星明かりを散らしている。星が瞬いているように見えるが、風のせいだ。',
    damage: 1,
    quill: 3
  },
  {
  ...
  },
  {
    ...
    resultText: '透き通った風が星空に輝いている。空気が澄み渡り、見たことのないほど多くの星が見える。深呼吸すると体が軽くなった。',
    damage: -1,
    quill: 6,
    rewardItems: [{ id: 'item_r05_clear_wind', name: '星空の息', description: '澄んだ風を瓶に閉じ込めた。開けると星の匂いがする', sellPrice: 10 }]
  },
  {
    id: 'r05_cursed_wind',
  ...
  },
  {
    ...
    resultText: '眠い風が星空に輝いている。生温い夜風が顔を撫でる。星を数えているうちに眠ってしまった。',
    damage: 0,
    quill: 4
  },
  {
    ...
    resultText: '小さな炎が星空に輝いている。蝋燭ほどの火が丘の上で揺れている。星と火と、二つの光に挟まれて温かい。旅の疲れが癒えた。',
    damage: -1,
    quill: 5
  },
  {
    ...
    resultText: '優しい炎が星空に輝いている。暖炉のような温もりの火が丘に灯っている。星空と優しい火で最高の休息だ。',
    damage: -1,
    quill: 6
  },
  {
  ...
  },
  {
    ...
    resultText: '堅い炎が星空に輝いている。消えない炎が丘の上で揺らがずに燃えている。風にも負けない。道標になる。',
    damage: 0,
    quill: 5
  },
  {
    ...
    resultText: '鋭い炎が星空に輝いている。一点集中の火が星に向かって伸びている。光の柱のようだ。近づくと熱い。',
    damage: 2,
    quill: 4
  },
  {
    ...
    resultText: '壊れた炎が星空に輝いている。緑や紫に明滅する炎。温かくないが、星空と合わさって幻想的だ。',
    damage: 0,
    quill: 5
  },
  {
  ...
  },
  {
    ...
    resultText: '凍てついた炎が星空に輝いている。青白い炎が霜を纏って星空の下で燃えている。冷たい温もりで疲れが和らぐ。',
    damage: 0,
    quill: 6,
    rewardItems: [{ id: 'item_r05_frozen_flame', name: '星霜の火', description: '凍った炎の欠片。星明かりの下でだけ温かく光る', sellPrice: 12 }]
  },
  {
    id: 'r05_clear_flame',
    conditions: { s1: 'mod_clear', s2: 'subj_flame' },
    resultText: '透き通った炎が星空に輝いている。見えない炎。空気の揺らぎだけが星の光を歪めている。体がほんのり温かい。',
    damage: 0,
    quill: 5
  },
  {
  ...
  },
  {
    ...
    resultText: '眠い炎が星空に輝いている。熾火が赤く明滅している。星と熾火の点滅に誘われて、深い眠りに落ちた。',
    damage: -1,
    quill: 4
  },
  {
    ...
    resultText: '小さな氷が星空に輝いている。掌の氷に星が映っている。溶ける前に握りしめた。冷たくて目が覚める。',
    damage: 0,
    quill: 4
  },
  {
    ...
    resultText: '優しい氷が星空に輝いている。額に当てると星を見ながら熱が引いていく。冷たくて気持ちいい。',
    damage: -1,
    quill: 5
  },
  {
  ...
  },
  {
    ...
    resultText: '堅い氷が星空に輝いている。万年氷が丘の上で月光を反射している。鏡のように星が二重に見える。',
    damage: 0,
    quill: 5
  },
  {
    ...
    resultText: '鋭い氷が星空に輝いている。氷柱が星明かりを反射して刃のように光っている。足元に気をつけた。',
    damage: 1,
    quill: 3
  },
  {
    ...
    resultText: '壊れた氷が星空に輝いている。ひび割れた氷の破片が星明かりで宝石のように散らばっている。',
    damage: 0,
    quill: 4
  },
  {
  ...
  },
  {
    ...
    resultText: '透き通った氷が星空に輝いている。完全に透明な氷がレンズになって、星を大きく映している。天体観測だ。',
    damage: 0,
    quill: 6,
    rewardItems: [{ id: 'item_r05_clear_ice', name: '星のレンズ', description: '星を拡大する透明な氷。溶けても効果が残る不思議な欠片', sellPrice: 12 }]
  },
  {
    id: 'r05_cursed_ice',
  ...
  },
  {
    ...
    resultText: '眠い氷が星空に輝いている。ゆっくり溶ける音が子守唄のようだ。星を見ながら眠りに落ちた。',
    damage: 0,
    quill: 4
  },
  {
    ...
    resultText: '小さな影が星空に輝いている。丘の上に小さな黒い染み。月明かりで影が星の形をしている。',
    damage: 0,
    quill: 4
  },
  {
    ...
    resultText: '優しい影が星空に輝いている。誰かが隣にいるかのような影。一緒に星を見上げた。孤独が和らぐ。',
    damage: -1,
    quill: 5
  },
  {
  ...
  },
  {
    ...
    resultText: '堅い影が星空に輝いている。地面に張りついた影が月光で黒く光っている。踏むと硬い。',
    damage: 1,
    quill: 3
  },
  {
    ...
    resultText: '鋭い影が星空に輝いている。月明かりで長く鋭い影が伸びている。何を指しているのか。星の方角だった。',
    damage: 0,
    quill: 5
  },
  {
    ...
    resultText: '壊れた影が星空に輝いている。めくれ上がった影が星空に向かって伸びている。影が星に手を伸ばしている。',
    damage: 0,
    quill: 5
  },
  {
  ...
  },
  {
    ...
    resultText: '凍てついた影が星空に輝いている。凍りついた影が月光で黒い氷のように光っている。本体はもういない。',
    damage: 1,
    quill: 4
  },
  {
    ...
    resultText: '透き通った影が星空に輝いている。半透明の影が星光を通している。影なのに光を遮らない。不思議だ。',
    damage: 0,
    quill: 5
  },
  {
  ...
  },
  {
    ...
    resultText: '眠い影が星空に輝いている。影が縮んで動かない。月が真上にあるからだ。影と一緒に休んだ。',
    damage: 0,
    quill: 3
  },
  {
    ...
    resultText: '小さな歌が星空に輝いている。どこからか聞こえる鼻歌。星空に溶けていく旋律。',
    damage: 0,
    quill: 5
  },
  {
    ...
    resultText: '優しい歌が星空に輝いている。子守唄が星空から降ってくる。傷がじんわり温かくなった。体が楽になる。',
    damage: -1,
    quill: 6,
    rewardItems: [{ id: 'item_r05_gentle_song', name: '星の子守唄', description: '星空の下で聴いた旋律。口ずさむと眠くなる', sellPrice: 10 }]
  },
  {
    id: 'r05_fire_song',
  ...
  },
  {
    ...
    resultText: '堅い歌が星空に輝いている。止まらない旋律が夜空に響き渡っている。星の配置が変わらないように、歌も変わらない。',
    damage: 1,
    quill: 4
  },
  {
    ...
    resultText: '鋭い歌が星空に輝いている。金切り声のような高音が星空を切り裂く。耳が痛い。星が震えている気がする。',
    damage: 2,
    quill: 3
  },
  {
    ...
    resultText: '壊れた歌が星空に輝いている。途中で止まる旋律。星空の静寂が続きを埋めている。それもまた音楽だ。',
    damage: 0,
    quill: 5
  },
  {
  ...
  },
  {
    ...
    resultText: '凍てついた歌が星空に輝いている。旋律が凍って結晶になり、星と一緒に降ってくる。触れると音が弾けた。',
    damage: 1,
    quill: 5
  },
  {
    ...
    resultText: '透き通った歌が星空に輝いている。純粋な旋律が星空に昇っていく。聴いていると心が洗われる。疲れが遠のいた。',
    damage: -1,
    quill: 7,
    rewardItems: [{ id: 'item_r05_clear_song', name: '星歌の結晶', description: '透き通った歌が星に触れてできた結晶。音と光が同時に出る', sellPrice: 15 }]
  },
  {
    id: 'r05_cursed_song',
  ...
  },
  {
    ...
    resultText: '眠い歌が星空に輝いている。子守唄と星空。最強の組み合わせだ。星を数える前に眠っていた。',
    damage: -1,
    quill: 5
  },
  {
    ...
    resultText: '小さな沈黙が星空に輝いている。ふと音が消えた。星明かりだけの世界。一瞬の完璧な静寂。',
    damage: 0,
    quill: 5
  },
  {
    ...
    resultText: '優しい沈黙が星空に輝いている。言葉がなくても満ちている。星空と静けさだけで十分だ。深く休めた。',
    damage: -1,
    quill: 6
  },
  {
  ...
  },
  {
    ...
    resultText: '堅い沈黙が星空に輝いている。音が吸い込まれる。自分の呼吸すら聞こえない。星だけが音のない世界で輝いている。',
    damage: 1,
    quill: 5
  },
  {
    ...
    resultText: '鋭い沈黙が星空に輝いている。刺すような静寂。星の光すら音を立てているような気がする。',
    damage: 1,
    quill: 4
  },
  {
    ...
    resultText: '壊れた沈黙が星空に輝いている。静寂のはずなのに、どこからかノイズが混じる。星が瞬くたびに音がする気がする。',
    damage: 1,
    quill: 3
  },
  {
    ...
    resultText: '屈強な沈黙が星空に輝いている。圧倒的な無音が丘を支配している。星空と沈黙の中に、自分だけがいる。',
    damage: 1,
    quill: 5
  },
  {
  ...
  },
  {
    ...
    resultText: '透き通った沈黙が星空に輝いている。完全な静寂と完全な星空。世界が澄み切っている。体の奥まで休まった。',
    damage: -1,
    quill: 7
  },
  {
  ...
  },
  {
    ...
    resultText: '眠い沈黙が星空に輝いている。静かすぎて意識が遠のく。星を見上げたまま眠りに落ちた。',
    damage: 0,
    quill: 4
  },
  {
    ...
    resultText: '小さな騎士が星空に輝いている。子供の騎士が丘の上で星を指さしている。兜越しに見えているのだろうか。',
    damage: 0,
    quill: 5
  },
  {
    ...
    resultText: '優しい騎士が星空に輝いている。剣を地に刺し、星空を見上げている。隣に座れと鎧の肩を叩いた。',
    damage: -1,
    quill: 5
  },
  {
  ...
  },
  {
    ...
    resultText: '堅い騎士が星空に輝いている。分厚い鎧が月光で銀色に光っている。微動だにしない。星空の番人のようだ。',
    damage: 0,
    quill: 4
  },
  {
    ...
    resultText: '鋭い騎士が星空に輝いている。冷たい目が星明かりで光っている。星空を見る余裕はないらしい。',
    damage: 1,
    quill: 3
  },
  {
    ...
    resultText: '壊れた騎士が星空に輝いている。へこんだ鎧で丘に座っている。折れた剣を膝に置いて、星を見上げている。',
    damage: 0,
    quill: 6,
    rewardItems: [{ id: 'item_r05_broken_knight', name: '騎士の折れ剣', description: '星明かりの下で拾った折れた剣。まだ誓いが宿っている', sellPrice: 10 }]
  },
  {
  ...
  },
  {
    ...
    resultText: '凍てついた騎士が星空に輝いている。氷に閉じ込められた騎士が月光で白く輝いている。氷像のように美しい。',
    damage: 1,
    quill: 5
  },
  {
    ...
    resultText: '透き通った騎士が星空に輝いている。影の薄い騎士。星明かりの中にかろうじて輪郭が見える。忘れ去られた騎士が星を見ている。',
    damage: 0,
    quill: 6
  },
  {
  ...
  },
  {
    ...
    resultText: '眠い騎士が星空に輝いている。槍にもたれて舟を漕いでいる。星空の見張りだが、星を数えて眠ってしまったらしい。',
    damage: 0,
    quill: 5
  },
  {
    ...
    resultText: '小さな魔女が星空に輝いている。少女の魔女が箒に乗って星空を飛んでいる。小さな影が月を横切った。',
    damage: 0,
    quill: 6,
    rewardItems: [{ id: 'item_r05_small_witch', name: '魔女の星屑', description: '箒で飛んだ魔女が落とした星の粉。手の中で光る', sellPrice: 10 }]
  },
  {
    id: 'r05_gentle_witch',
    conditions: { s1: 'mod_gentle', s2: 'subj_witch' },
    resultText: '優しい魔女が星空に輝いている。星の下で薬を調合している。飲んでみろと言われた。傷が楽になった。',
    damage: -1,
    quill: 6
  },
  {
  ...
  },
  {
    ...
    resultText: '堅い魔女が星空に輝いている。頑固な老魔女が丘の上で微動だにしない。星の動きを観測しているらしい。',
    damage: 0,
    quill: 4
  },
  {
    ...
    resultText: '鋭い魔女が星空に輝いている。鉤鼻の魔女が星で占っている。こちらの運命を読んでいるようだ。目が合った。',
    damage: 1,
    quill: 4
  },
  {
  ...
  },
  {
    ...
    resultText: '屈強な魔女が星空に輝いている。太い腕を天にかざして星を動かそうとしている。力ずくの天文学だ。',
    damage: 1,
    quill: 5
  },
  {
  ...
  },
  {
    ...
    resultText: '透き通った魔女が星空に輝いている。老いて透けた魔女。星空が体を通して見える。魔女自身が星座のようだ。',
    damage: 0,
    quill: 6
  },
  {
  ...
  },
  {
    ...
    resultText: '眠い魔女が星空に輝いている。帽子を枕に星空の下で眠っている。大釜は月明かりで静かに光っている。',
    damage: 0,
    quill: 4
  },
  {
    ...
    resultText: '小さな王が星空に輝いている。子供の王が丘の上で星を見上げている。王冠が月光で小さく光る。',
    damage: 0,
    quill: 5
  },
  {
    ...
    resultText: '優しい王が星空に輝いている。質素な衣の王が丘の上で星を指さしている。あれが故郷の星だと教えてくれた。',
    damage: -1,
    quill: 5
  },
  {
  ...
  },
  {
    ...
    resultText: '堅い王が星空に輝いている。石の玉座を丘の上に持ってきたらしい。微動だにせず星を見ている。',
    damage: 0,
    quill: 4
  },
  {
    ...
    resultText: '鋭い王が星空に輝いている。鷹の目が星空を読んでいる。国の未来を星に問うているのだ。',
    damage: 1,
    quill: 4
  },
  {
    ...
    resultText: '壊れた王が星空に輝いている。歪んだ王冠の王が星を見上げている。虚ろな目に星が映っている。何を見ているのか。',
    damage: 0,
    quill: 5
  },
  {
  ...
  },
  {
    ...
    resultText: '透き通った王が星空に輝いている。存在が希薄な王。星空が体を通して見える。王冠だけがかすかに光っている。',
    damage: 0,
    quill: 5
  },
  {
  ...
  },
  {
    ...
    resultText: '眠い王が星空に輝いている。王冠がずれたまま丘の草の上で眠っている。星空が天蓋だ。',
    damage: 0,
    quill: 4
  },
  {
    ...
    resultText: '小さな亡霊が星空に輝いている。子供の霊が丘の上で星を数えている。数え歌が聞こえる。',
    damage: 0,
    quill: 5
  },
  {
    ...
    resultText: '優しい亡霊が星空に輝いている。穏やかな霊が星空を見上げて微笑んでいる。生前の記憶を見ているのだろう。',
    damage: 0,
    quill: 5
  },
  {
  ...
  },
  {
    ...
    resultText: '堅い亡霊が星空に輝いている。何百年もこの丘に立っている霊。星の動きだけを見つめ続けている。',
    damage: 0,
    quill: 4
  },
  {
  ...
  },
  {
    ...
    resultText: '壊れた亡霊が星空に輝いている。記憶を失った霊が星を見ている。何を思い出そうとしているのか。',
    damage: 0,
    quill: 5
  },
  {
  ...
  },
  {
    ...
    resultText: '透き通った亡霊が星空に輝いている。成仏しかけた霊が星光に溶けていく。最後に星空を見上げて消えた。',
    damage: 0,
    quill: 6,
    rewardItems: [{ id: 'item_r05_clear_ghost', name: '亡霊の星光', description: '亡霊が消えた場所に残った光。瓶に入れると星のように瞬く', sellPrice: 10 }]
  },
  {
    id: 'r05_cursed_ghost',
  ...
  },
  {
    ...
    resultText: '眠い亡霊が星空に輝いている。うつらうつらしている霊。存在感が星明かりで揺れている。害はない。',
    damage: 0,
    quill: 3
  },
  {
    ...
    resultText: '小さな鏡が星空に輝いている。手鏡が丘に落ちている。覗くと星空が映っていた。手の中に星がある。',
    damage: 0,
    quill: 5
  },
  {
    ...
    resultText: '優しい鏡が星空に輝いている。覗くと少しだけ元気な自分が映る。星空の下で勇気をもらった。',
    damage: -1,
    quill: 5
  },
  {
  ...
  },
  {
    ...
    resultText: '堅い鏡が星空に輝いている。傷のつかない鏡面が星空を完璧に映している。地上にもう一つの星空がある。',
    damage: 0,
    quill: 5
  },
  {
  ...
  },
  {
    ...
    resultText: '壊れた鏡が星空に輝いている。ひび割れた鏡が星空を何十にも分割して映している。万華鏡の星空だ。',
    damage: 0,
    quill: 6,
    rewardItems: [{ id: 'item_r05_broken_mirror', name: '万華鏡の星', description: '壊れた鏡の破片。覗くと星空が万華鏡になる', sellPrice: 12 }]
  },
  {
    id: 'r05_mighty_mirror',
    conditions: { s1: 'mod_mighty', s2: 'subj_mirror' },
    resultText: '屈強な鏡が星空に輝いている。巨大な姿見が丘に立っている。鏡の中の星空と本物の星空が向かい合って、無限に続く。',
    damage: 0,
    quill: 5
  },
  {
    ...
    resultText: '凍てついた鏡が星空に輝いている。霜に覆われた鏡面がかろうじて星を映している。触ると手が凍りつきそうだ。',
    damage: 1,
    quill: 4
  },
  {
    ...
    resultText: '透き通った鏡が星空に輝いている。透明な鏡。覗くと鏡の向こうにも星空が広がっている。どちらが本物かわからない。',
    damage: 0,
    quill: 7,
    rewardItems: [{ id: 'item_r05_clear_mirror', name: '鏡裏の星', description: '鏡の向こうの星空から持ち帰った光。見たことのない星だ', sellPrice: 15 }]
  },
  {
  ...
  },
  {
    ...
    resultText: '眠い鏡が星空に輝いている。鏡面が曇って、星空がぼんやり映っている。覗くと自分の寝顔が見えた。',
    damage: 0,
    quill: 4
  },
  {
    ...
    resultText: '小さな人形が星空に輝いている。指人形が丘の草の上に立っている。星明かりで小さな影ができた。',
    damage: 0,
    quill: 3
  },
  {
    ...
    resultText: '優しい人形が星空に輝いている。笑顔の縫いぐるみが星空の下にぽつんと座っている。抱くと温かい。',
    damage: 0,
    quill: 4
  },
  {
  ...
  },
  {
    ...
    resultText: '堅い人形が星空に輝いている。木彫りの人形が月光で白く光っている。表情がない。見上げているのか、何も見ていないのか。',
    damage: 0,
    quill: 4
  },
  {
  ...
  },
  {
    ...
    resultText: '壊れた人形が星空に輝いている。首がもげかけた人形が丘に転がっている。残った目に星が映っている。',
    damage: 0,
    quill: 5
  },
  {
    ...
    resultText: '屈強な人形が星空に輝いている。等身大の木彫り人形が丘に立っている。月を背にした影が人間に見える。',
    damage: 1,
    quill: 4
  },
  {
    ...
    resultText: '凍てついた人形が星空に輝いている。氷の人形が星明かりで透き通って光る。溶けたら二度と見られない美しさだ。',
    damage: 0,
    quill: 6
  },
  {
    ...
    resultText: '透き通った人形が星空に輝いている。硝子の人形に星空が映り込んでいる。人形の中に宇宙がある。',
    damage: 0,
    quill: 7,
    rewardItems: [{ id: 'item_r05_clear_doll', name: '星入り硝子人形', description: '中に星空が閉じ込められた人形。暗闇で輝く', sellPrice: 15 }]
  },
  {
    id: 'r05_cursed_doll',
  ...
  },
  {
    ...
    resultText: '眠い人形が星空に輝いている。目を閉じた人形が草の上に横たわっている。持つと眠くなる。星空の下で一緒に眠った。',
    damage: 0,
    quill: 4
  },
  {
    ...
    resultText: '小さな雨が星空に輝いている。霧雨が星明かりを含んで光の粒になっている。宝石が降っているようだ。',
    damage: 0,
    quill: 5
  },
  {
    ...
    resultText: '優しい雨が星空に輝いている。温かい慈雨が星明かりの中を降っている。雨粒が星の光を映して、光の糸のようだ。',
    damage: -1,
    quill: 6
  },
  {
  ...
  },
  {
    ...
    resultText: '堅い雨が星空に輝いている。雹が星空から降ってくる。氷の粒が月光で光る。頭を打たれた。星を見る余裕がない。',
    damage: 2,
    quill: 2
  },
  {
    ...
    resultText: '鋭い雨が星空に輝いている。針のような雨が星明かりに光って銀の線に見える。美しいが痛い。',
    damage: 2,
    quill: 3
  },
  {
    ...
    resultText: '壊れた雨が星空に輝いている。途切れ途切れの雨。降ったり止んだり。星が見えたり隠れたり。',
    damage: 0,
    quill: 3
  },
  {
  ...
  },
  {
    ...
    resultText: '凍てついた雨が星空に輝いている。凍雨が降って丘を氷の鏡にした。その鏡に星空が映っている。足元に宇宙がある。',
    damage: 1,
    quill: 6,
    rewardItems: [{ id: 'item_r05_frozen_rain', name: '氷鏡の星', description: '凍雨が作った氷片。中に星空が映り続けている', sellPrice: 12 }]
  },
  {
    id: 'r05_clear_rain',
    conditions: { s1: 'mod_clear', s2: 'subj_rain' },
    resultText: '透き通った雨が星空に輝いている。澄んだ雨が星の光を含んで降っている。浴びると体が清まった。星が近くなった。',
    damage: -1,
    quill: 6
  },
  {
  ...
  },
  {
    ...
    resultText: '眠い雨が星空に輝いている。しとしとと降る雨音と星明かり。最高の寝床だ。丘の上でぐっすり眠った。',
    damage: -1,
    quill: 5
  },
];
